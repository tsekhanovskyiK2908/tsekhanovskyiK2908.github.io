...
export class TourRepository {
    ...
    tours: Tour[] = [
        ...
        new Tour(3,'The snow adventurer', 3, 30, 2, NightLocation.hotels, TourDifficulty.easy, 897),
        new Tour(2,'The forest hiker', 3, 30, 2, NightLocation.hotels, TourDifficulty.easy, 497),
        new Tour(1,'The sea explorer', 3, 30, 2, NightLocation.hotels, TourDifficulty.easy, 497),
        // new Tour(1,'The sea explorer', 3, 30, 2, NightLocation.hotels, TourDifficulty.easy, 497),
    ];
